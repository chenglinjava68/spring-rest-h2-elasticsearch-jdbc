...
VALUES
    (1, 'batman', 'Bruce Wayne', 'password'),
    (2, 'superman', 'Clark Kent', 'password'),
    (3, 'catwoman', 'Selina Kyle', 'password'),
    (4, 'daredevil', 'Matt Murdock', 'password'),
    (5, 'alfred', 'Alfred Pennyworth', 'password'),
    (6, 'dococ', 'Otto Octavius', 'password'),
    (7, 'zod', 'Dru-Zod', 'password'),
    (8, 'spiderman', 'Peter Parker', 'password'),
    (9, 'ironman', 'Tony Stark', 'password'),
    (10, 'profx', 'Charles Xavier', 'password');

-- Roles
INSERT INTO user_roles (id, role) VALUES ('1','ROLE_ADMIN');
INSERT INTO user_roles (id, role) VALUES ('2','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('3','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('4','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('5','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('6','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('7','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('8','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('9','ROLE_USER');
INSERT INTO user_roles (id, role) VALUES ('10','ROLE_USER');
